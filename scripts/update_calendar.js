...
const PATH_PAD = '../../../../../';
//const PATH_PAD = '../';
const TOKEN_PATH = PATH_PAD + '.secrets/token.json';


function getEvents(cb) {
    fs.readFile(PATH_PAD + '.secrets/commonfree_credentials.json', (err, content) => {
...
function authorize(credentials, callback, cb) {
    ...
    fs.readFile(TOKEN_PATH, (err, token) => {
        if (err) return getAccessToken(oAuth2Client, callback, cb);
